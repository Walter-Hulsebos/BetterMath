...
namespace CGTK.Utilities.BetterMath.Editor
{
    ...
    class PostNormalizedVectorDrawer : PrimitiveVectorDrawer
    {
        ...
        class VectorPropertyGUIData
        {
            ...
            readonly Dictionary<SerializedProperty, F64x4> m_PostNormalizedValues = new Dictionary<SerializedProperty, F64x4>();
            ...
            void UpdatePostNormalizedValues()
            {
                ...
                {
                    var postNormalizedValue = new F64x4();
            ...
            public void PostNormalize(Func<F64x4, F64x4> normalize)
            {
                m_VectorProperty.serializedObject.ApplyModifiedProperties();
                foreach (var target in m_PostNormalizedValues)
                {
        ...
        protected virtual F64x4 Normalize(F64x4 value)
        {
            return Maths.NormalizeSafe(value);
        }
