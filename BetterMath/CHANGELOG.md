...
## [1.2.2] - 2021-06-28
### Added
* Added `[Il2CppEagerStaticClassConstruction]` to CGTK.Utilities.BetterMath types to run static constructors at startup. This improves IL2CPP performance slightly for types that have static constructors.
...
### Internal (Not ready for production)
* Added `CGTK.Utilities.BetterMath.Geometry.Plane` to represent planes in 3D space.
* Added more `MinMaxAABB` functionality from `Unity.Physics.Aabb`.
* Added `CGTK.Utilities.BetterMath.Geometry.Math` to hold static functions like AABB transformations.
* Added `MinMaxAABB`.
