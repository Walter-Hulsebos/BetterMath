...
namespace CGTK.Utilities.BetterMath
{
    ...
    public partial struct F32x2x2 : System.IEquatable<F32x2x2>, IFormattable
    {
        ...
        public static readonly F32x2x2 identity = new F32x2x2(1.0f, 0.0f,   0.0f, 1.0f);

        /// <summary>float2x2 zero value.</summary>
        public static readonly F32x2x2 zero;

        /// <summary>Constructs a float2x2 matrix from two F32x2 vectors.</summary>
        ...
        public F32x2x2(F32x2 c0, F32x2 c1)
        {
            this.c0 = c0;
            this.c1 = c1;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(float m00, float m01,
                        float m10, float m11)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(bool v)
        {
            this.c0 = Maths.select(new F32x2(0.0f), new F32x2(1.0f), v);
            this.c1 = Maths.select(new F32x2(0.0f), new F32x2(1.0f), v);
        }

        /// <summary>Constructs a float2x2 matrix from a Boolx2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Boolx2x2 to convert to float2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(Boolx2x2 v)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(int v)
        {
            this.c0 = v;
            this.c1 = v;
        }

        /// <summary>Constructs a float2x2 matrix from a I32x2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">I32x2x2 to convert to float2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(I32x2x2 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(uint v)
        {
            this.c0 = v;
            this.c1 = v;
        }

        /// <summary>Constructs a float2x2 matrix from a U32x2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">U32x2x2 to convert to float2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(U32x2x2 v)
        {
            this.c0 = v.c0;
            this.c1 = v.c1;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(double v)
        {
            this.c0 = (F32x2)v;
            this.c1 = (F32x2)v;
        }

        /// <summary>Constructs a float2x2 matrix from a F64x2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">F64x2x2 to convert to float2x2</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public F32x2x2(F64x2x2 v)
        {
            this.c0 = (F32x2)v.c0;
            this.c1 = (F32x2)v.c1;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator F32x2x2(float v) { return new F32x2x2(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator F32x2x2(bool v) { return new F32x2x2(v); }

        /// <summary>Explicitly converts a Boolx2x2 matrix to a float2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Boolx2x2 to convert to float2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator F32x2x2(Boolx2x2 v) { return new F32x2x2(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator F32x2x2(int v) { return new F32x2x2(v); }

        /// <summary>Implicitly converts a I32x2x2 matrix to a float2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">I32x2x2 to convert to float2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator F32x2x2(I32x2x2 v) { return new F32x2x2(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator F32x2x2(uint v) { return new F32x2x2(v); }

        /// <summary>Implicitly converts a U32x2x2 matrix to a float2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">U32x2x2 to convert to float2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator F32x2x2(U32x2x2 v) { return new F32x2x2(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator F32x2x2(double v) { return new F32x2x2(v); }

        /// <summary>Explicitly converts a F64x2x2 matrix to a float2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">F64x2x2 to convert to float2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator F32x2x2(F64x2x2 v) { return new F32x2x2(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 operator * (F32x2x2 lhs, F32x2x2 rhs) { return new F32x2x2 (lhs.c0 * rhs.c0, lhs.c1 * rhs.c1); }
        ...
        /// <returns>float2x2 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 operator * (F32x2x2 lhs, float rhs) { return new F32x2x2 (lhs.c0 * rhs, lhs.c1 * rhs); }
        ...
        /// <returns>float2x2 result of the componentwise multiplication.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 operator * (float lhs, F32x2x2 rhs) { return new F32x2x2 (lhs * rhs.c0, lhs * rhs.c1); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 operator ++ (F32x2x2 val) { return new F32x2x2 (++val.c0, ++val.c1); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolx2x2 operator < (F32x2x2 lhs, F32x2x2 rhs) { return new Boolx2x2 (lhs.c0 < rhs.c0, lhs.c1 < rhs.c1); }
        ...
        /// <returns>Boolx2x2 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolx2x2 operator < (F32x2x2 lhs, float rhs) { return new Boolx2x2 (lhs.c0 < rhs, lhs.c1 < rhs); }
        ...
        /// <returns>Boolx2x2 result of the componentwise less than.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Boolx2x2 operator < (float lhs, F32x2x2 rhs) { return new Boolx2x2 (lhs < rhs.c0, lhs < rhs.c1); }
...
#endif
                fixed (F32x2x2* array = &this) { return ref ((F32x2*)array)[index]; }
            }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(F32x2x2 rhs) { return c0.Equals(rhs.c0) && c1.Equals(rhs.c1); }

        /// <summary>Returns true if the float2x2 is equal to a given float2x2, false otherwise.</summary>
        /// <param name="o">Right hand side argument to compare equality with.</param>
        /// <returns>The result of the equality comparison.</returns>
        public override bool Equals(object o) { return o is F32x2x2 converted && Equals(converted); }
        ...
        {
            return string.Format("new F32x2x2({0}f, {1}f,  {2}f, {3}f)", c0.x, c1.x, c0.y, c1.y);
        }
        ...
        {
            return string.Format("new F32x2x2({0}f, {1}f,  {2}f, {3}f)", c0.x.ToString(format, formatProvider), c1.x.ToString(format, formatProvider), c0.y.ToString(format, formatProvider), c1.y.ToString(format, formatProvider));
        }
    ...
    {
        /*
        /// <summary>Returns a float2x2 matrix constructed from two F32x2 vectors.</summary>
        /// <param name="c0">The matrix column c0 will be set to this value.</param>
        /// <param name="c1">The matrix column c1 will be set to this value.</param>
        /// <returns>float2x2 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(F32x2 c0, F32x2 c1) { return new F32x2x2(c0, c1); }
        ...
        /// <returns>float2x2 constructed from arguments.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(float m00, float m01,
                                        float m10, float m11)
        {
            return new F32x2x2(m00, m01,
                                m10, m11);
        }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(float v) { return new F32x2x2(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(bool v) { return new F32x2x2(v); }

        /// <summary>Return a float2x2 matrix constructed from a Boolx2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">Boolx2x2 to convert to float2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(Boolx2x2 v) { return new F32x2x2(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(int v) { return new F32x2x2(v); }

        /// <summary>Return a float2x2 matrix constructed from a I32x2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">I32x2x2 to convert to float2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(I32x2x2 v) { return new F32x2x2(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(uint v) { return new F32x2x2(v); }

        /// <summary>Return a float2x2 matrix constructed from a U32x2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">U32x2x2 to convert to float2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(U32x2x2 v) { return new F32x2x2(v); }
        ...
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(double v) { return new F32x2x2(v); }

        /// <summary>Return a float2x2 matrix constructed from a F64x2x2 matrix by componentwise conversion.</summary>
        /// <param name="v">F64x2x2 to convert to float2x2</param>
        /// <returns>Converted value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 new F32x2x2(F64x2x2 v) { return new F32x2x2(v); }
        */
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 transpose(F32x2x2 v)
        {
            return new F32x2x2(
                v.c0.x, v.c0.y,
                v.c1.x, v.c1.y);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static F32x2x2 inverse(F32x2x2 m)
        {
            float a = m.c0.x;
            float b = m.c1.x;
            float c = m.c0.y;
            ...
            return new F32x2x2(d, -b, -c, a) * (1.0f / det);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float determinant(F32x2x2 m)
        {
            float a = m.c0.x;
            float b = m.c1.x;
            float c = m.c0.y;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint hash(F32x2x2 v)
        {
            return csum(x:
                AsU32(v.c0) * new U32x2(0x9C9F0823u, 0x5A9CA13Bu) +
                AsU32(v.c1) * new U32x2(0xAFCDD5EFu, 0xA88D187Du)) + 0xCF6EBA1Du;
        }

        /// <summary>
        /// Returns a U32x2 vector hash code of a float2x2 matrix.
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U32x2 hashwide(F32x2x2 v)
        {
            return (AsU32(v.c0) * new U32x2(0x9D88E5A1u, 0xEADF0775u) +
                    AsU32(v.c1) * new U32x2(0x747A9D7Bu, 0x4111F799u)) + 0xB5F05AF1u;
        }
